...
series_list = ['rc', 'as_', 'ash2o','ours']
# fillcolors    = ['lightblue', 'darkseagreen', 'wheat', 'lightsalmon', 'darkseagreen',  'lightgrey']
fillcolors = ['gray',  'lightgrey', 'dodgerblue','lightsalmon',  'lightcoral']#lightsalmon
legend_names = ['ReComp', 'AS', 'AS+H2O+LRU', 'IMPRESS']
