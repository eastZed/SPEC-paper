...
axis(drawable=d, style=axisstyle, ticstyle=axisticstyle,
         ...
         xmanual=[['LM-7B', 0], ['LM-13B',1], ['LM-7B', 2], ['LM-13B', 3]])
...
c.text(coord=[d.left()+40, d.top()-5], rotate=0,text='PIQA', size=legendSize, anchor='c,h')
c.text(coord=[d.left()+120, d.top()-5], rotate=0,text='COPA', size=legendSize, anchor='c,h')

c.line(coord=[[d.left()+80, d.bottom()], [d.left()+80, d.top()]], linedash=[2,2])
