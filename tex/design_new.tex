...
\cp{
\textbf{Design.} Loading important KVs during inference lies on the critical path and therefore introduces noticeable latency, as shown by the K and V loading in Figure~\ref{fig:simiload-ttft}(b).
