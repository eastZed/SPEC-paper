...
\cp{
	...
	For example, if the prefetching time window allows prefetching only one SSD chunk, the ideal prefetching order based on importance would retrieve $t_0$ and  $t_4$, as the prefetch policy in \S\ref{sec:techc}. 
