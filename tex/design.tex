...
During this process, the system also predicts the next set of important KVs and proactively prefetches them to overlap I/O with computation, thereby further mitigating data access latency (\cref{sec:techc}). 
