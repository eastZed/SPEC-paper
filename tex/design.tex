...
%此外，在这些KV中有一些会被判定为预取KV，会在推理计算过程中被提前取出。


%The metadata in the CPU memory is
%organized using a radix tree~\cite{sglang-arxiv23}, which facilitates quick searches for the reusable prefix KVs. 
